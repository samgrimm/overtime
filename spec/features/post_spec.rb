...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a list of Posts' do
      ...
      visit posts_path
      expect(page).to have_text("Some Work Performed")
      expect(page).to have_text("Some more content")
    end
    ...
    it "has a scope so that only post creators can see their posts" do
      ...
      visit posts_path
      expect(page).to have_content(/Some Work Performed|Some more content/)
